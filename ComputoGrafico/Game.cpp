...
void Game::Init()
{
	...
	std::vector<std::string> paths = {
		...
		"Assets/Models/floor2.obj",
		"Assets/Models/bone.obj",
		"Assets/Models/skull.obj",
		"Assets/Models/painting.obj",
		"Assets/Models/fWall.obj",
		"Assets/Models/bWall.obj",
		"Assets/Models/Sopa.obj",
		"Assets/Models/Caldero.obj",
	};
	LoadModels(paths);

	std::vector<std::string> pathsEnemies = {
	//"Assets/Models/pina_pose.obj",
	"Assets/Models/bender.obj",
	};
...
void Game::LoadModels(const std::vector<std::string> &pathFileModels)
{
	for (auto path : pathFileModels)
	{
		...
		if (path == "Assets/Models/floor2.obj")
			model->AddTexture("Assets/Textures/Piso.png");
		if (path == "Assets/Models/lWall.obj" || path == "Assets/Models/rWall.obj" || path == "Assets/Models/bWall.obj" || path == "Assets/Models/fWall.obj")
			model->AddTexture("Assets/Textures/Pared.png");
		if (path == "Assets/Models/bone.obj")
			model->AddTexture("Assets/Textures/ColorHuesoGrande.png");
		if (path == "Assets/Models/skull.obj")
		{
			model->AddTexture("Assets/Textures/CraneoColor.png");
		}
		if (path == "Assets/Models/painting.obj")
		{
			model->AddTexture("Assets/Textures/CuadroColor.png");
		}
		if (path == "Assets/Models/Caldero.obj")
		{
			model->AddTexture("Assets/Textures/CalderoColor.png");
		}
		if (path == "Assets/Models/Sopa.obj")
		{
			model->AddTexture("Assets/Textures/SopaColor.png");
		}
		map.push_back(model);
	}
}
